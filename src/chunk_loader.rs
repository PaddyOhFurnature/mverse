                ...
                let surface_y = match top_vy {
                    ...
                    Some(_) => {
                        ...
                        if has_air {
                            ...
                            // Noise amplitude is ≤ 0.52 (med 0.4 + fine 0.12).  Push surface 2m
                            // above the top grid point so density is always clearly positive there
                            // and no phantom triangle can be generated by the MC zero-crossing.
                            max_v.y as f32 + 2.0 // all-solid: terrain continues above → no phantom
                        }
                    }
                };
