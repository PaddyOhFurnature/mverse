...
fn build_floor() -> Mesh {
    ...
    add_wall_with_gaps(
        ...
        wall_h,
        WALL_COLOUR,
        &module_gaps_on_side(WallSideId::North),
        hw,
    );
    // South wall (z = +s)
    add_wall_with_gaps(
        ...
        wall_h,
        WALL_COLOUR,
        &module_gaps_on_side(WallSideId::South),
        hw,
    );
    // East wall (x = +s)
    add_wall_with_gaps(
        ...
        wall_h,
        WALL_COLOUR,
        &module_gaps_on_side(WallSideId::East),
        hw,
    );
    // West wall (x = -s)
    add_wall_with_gaps(
        ...
        wall_h,
        WALL_COLOUR,
        &module_gaps_on_side(WallSideId::West),
        hw,
    );
...
fn add_wall_with_gaps(
    ...
    let mut gaps: Vec<(f32, f32)> = gap_centers
        .iter()
...
fn add_module_room(mesh: &mut Mesh, m: &MeshsiteModule) {
    ...
    add_horiz_quad(
        mesh,
        door_center + tangent * hw + ceil_off,
        corr_end + tangent * hw + ceil_off,
        corr_end - tangent * hw + ceil_off,
        door_center - tangent * hw + ceil_off,
        c,
    );
    ...
    add_horiz_quad(
        mesh,
        room_start - tangent * room_hw,
        room_end - tangent * room_hw,
        room_end + tangent * room_hw,
        room_start + tangent * room_hw,
        c,
    );
    ...
    add_horiz_quad(
        mesh,
        room_start + tangent * room_hw + ceil_off,
        room_end + tangent * room_hw + ceil_off,
        room_end - tangent * room_hw + ceil_off,
        room_start - tangent * room_hw + ceil_off,
        c,
    );
