#!/usr/bin/env python3
"""
Generate complete 256-entry Marching Cubes triangle table.
Based on Paul Bourke's canonical implementation.
"""

# Complete canonical marching cubes table - all 256 cases
# Each entry lists the edge indices that form triangles (in groups of 3)
...
def main():
    ...
    for i, edges in enumerate(TRI_TABLE):
        ...
        values = ", ".join(f"{x:2d}" for x in padded)
        comma = "," if i < 255 else ""
        print(f"[{values}]{comma}")
    print("]")
