...
fn test_affected_chunks_edge_boundary() {
    ...
    assert_eq!(
        affected.len(),
        4,
        "Edge boundary voxel should affect 4 chunks"
    );
}
...
fn test_affected_chunks_corner_boundary() {
    ...
    assert_eq!(
        affected.len(),
        8,
        "Corner boundary voxel should affect 8 chunks"
    );
}
